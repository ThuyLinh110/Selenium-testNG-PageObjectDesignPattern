...
public class C57_VerifyUserCanFilterTicketsByStatus extends BaseTest {
    ...
    public void c57_VerifyUserCanFilterTicketsByStatus() {
        ...
        randomStatus = Utilities.getMatchingValues(ticketValuesByHeader, filterValuesByHeader).get(0);
