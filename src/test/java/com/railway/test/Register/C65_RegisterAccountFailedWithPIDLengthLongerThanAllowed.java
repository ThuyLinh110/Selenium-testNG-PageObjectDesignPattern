...
public class C65_RegisterAccountFailedWithPIDLengthLongerThanAllowed extends BaseTest {

    @Test(description = "TC 65 - Verify user cannot register account with PID length is longer than allowed length")
